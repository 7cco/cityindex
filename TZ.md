# Техническое задание на проект: ГородИндекс
...
- **Аналитик** (зарегистрированный пользователь):  
  ...
  — Сравнение до 5 городов с визуализацией через столбчатые диаграммы  
  — Экспорт данных в CSV  
  — Просмотр динамики индекса за 2020-2024 гг.
...
— `inv_index` (индекс инвестиционной привлекательности)  
...
* **Сравнение городов**: Аналитик отмечает 2-5 городов, система генерирует столбчатую диаграмму Plotly с разбивкой по трем компонентам индекса (экономика, демография, инфраструктура) для наглядного сравнения сильных/слабых сторон.
...
`Индекс = 0.5 * (доходы на душу / медиана по региону) + 0.3 * (1 - уровень безработицы региона / 100 ) + 0.2 * (инфраструктурный балл)`
